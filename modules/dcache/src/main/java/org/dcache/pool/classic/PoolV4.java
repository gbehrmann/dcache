...
import org.dcache.pool.hsm.NearlineStorageHandler;
               ...
               CellMessageReceiver
{
        ...
        implements CompletionHandler<Void, PnfsId>
    {
        ...
        public void send(PnfsId pnfsId)
        {
            if (_message.getReturnCode() != 0) {
                _log.error("Fetch failed: {}", _message.getErrorObject());
                ...
                try {
                    ...
                    _log.error("Failed to remove replica: {}", e.getMessage());
        ...
        throws CacheException
    {
        ...
        FileAttributes fileAttributes = msg.getFileAttributes();
        String hsm = fileAttributes.getStorageInfo().getHsm();
