...
public class HtpasswdPlugin implements GPlazmaAuthenticationPlugin
{
    ...
    private final InputSupplier<? extends Reader> htpasswdSource;
    private long loadTime;

    public HtpasswdPlugin(Properties properties)
    {
        this(Files.newReaderSupplier(new File(properties.getProperty("gplazma.htpasswd.file")), Charsets.US_ASCII),
    ...
    public HtpasswdPlugin(InputSupplier<? extends Reader> htpasswdSource, long refreshPeriod)
    {
