...
public class HtpasswdPluginTest
{
    ...
    {
        HtpasswdPlugin plugin = new HtpasswdPlugin(CharStreams.newReaderSupplier(""), 0);
        plugin.authenticate(
    ...
    {
        HtpasswdPlugin plugin = new HtpasswdPlugin(CharStreams.newReaderSupplier("user:$apr1$X5ZCDJ6k$LmbjUJChwKdbrPb/3fFAU0"), 0);
        plugin.authenticate(
                Collections.emptySet(),
    ...
    {
        HtpasswdPlugin plugin = new HtpasswdPlugin(CharStreams.newReaderSupplier("user:$apr1$X5ZCDJ6k$LmbjUJChwKdbrPb/3fFAU0\nuser2:$apr1$cFgW0NZB$f50cUeavV3iz8dgVwRlWF."), 0);
        plugin.authenticate(
                Collections.emptySet(),
                Collections.<Object>singleton(new PasswordCredential("user", "wrong password")),
                Collections.<Principal>emptySet());
